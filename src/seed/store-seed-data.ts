...
// Seed data for initial Dental setup
...
export const seedProducts = [
  {
    ...
    description: 'This is a sample product for your Dental store.',
...
export const seedGlobals = {
  ...
  footer: {
    ...
    copyright: '© 2024 Dental. All rights reserved.',
  },
  settings: {
    siteName: 'Dental',
